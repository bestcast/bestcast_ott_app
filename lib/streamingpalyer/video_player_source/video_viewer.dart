...
import 'ui/video_core/video_core.dart';

export 'package:video_player/video_player.dart';
export 'domain/bloc/controller.dart';
export 'domain/entities/ads.dart';
export 'domain/entities/language.dart';
export 'domain/entities/settings_menu_item.dart';
export 'domain/entities/styles/video_viewer.dart';
export 'domain/entities/subtitle.dart';
export 'domain/entities/video_source.dart';
export 'domain/entities/volume_control.dart';
...
class VideoViewer extends StatefulWidget {
  const VideoViewer({
    ...
    this.enableHorizontalSwapingGesture = false,
