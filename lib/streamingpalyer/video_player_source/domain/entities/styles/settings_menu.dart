...
class SettingsMenuStyle {
  ...
  SettingsMenuStyle({
    ...
    this.items,
        ...
        speed = speed ?? Icon(Icons.speed, color: Colors.white, size: 20),
        selected = selected ?? Icon(Icons.done, color: Colors.white, size: 20),
        chevron = chevron ?? Icon(Icons.chevron_left, color: Colors.white);
