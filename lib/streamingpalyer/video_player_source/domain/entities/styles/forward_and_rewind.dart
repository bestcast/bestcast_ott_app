...
class ForwardAndRewindStyle {
  ...
  ForwardAndRewindStyle({
    ...
    this.spaceBeetweenBarAndText = 10,
        ...
        padding = padding ?? Margin.all(10),
        backgroundColor = backgroundColor ?? Colors.black.withOpacity(0.28),
        ripple = ripple ?? Colors.white.withOpacity(0.28),
        borderRadius = borderRadius ?? EdgeRadius.all(10),
        rewind = rewind ?? Icon(Icons.fast_rewind, color: Colors.white),
        forward = forward ?? Icon(Icons.fast_forward, color: Colors.white);
