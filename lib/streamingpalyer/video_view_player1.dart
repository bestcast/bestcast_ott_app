...
class MovieVideoViewer extends StatefulWidget {
  const MovieVideoViewer(this.movie, {super.key});
...
class MovieCardSlider extends StatefulWidget {
  const MovieCardSlider(this.movies, {super.key});
...
class SearchBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final TextStyle? titleSmall = context.textTheme.titleSmall;
    return CustomContainer(
      child: Row(children: [
        Padding(
          padding: const Margin.horizontal(kPadding),
          child: Icon(Icons.search, color: titleSmall?.color),
        ),
        Expanded(
          child: TextField(
            style: titleSmall,
